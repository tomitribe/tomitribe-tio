...
public class ColoredScores {
    ...
    private final ColoredLabels coloredLabels = new ColoredLabels();
    ...
    public Object intercept(final CrestContext crestContext) {
        ...
        final Stream<Score<Label>> stream = (Stream<Score<Label>>) response;

        return stream.map(this::color);
    }

    public String color(final Score<Label> score) {
        final PrintString out = new PrintString();
        out.print(coloredLabels.color(score.getValue()));
        out.print(" ");
        out.print(Colors.color(239, 143, score.getScore()));
        return out.toString();
    }
}
